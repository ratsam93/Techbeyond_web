          ...
          <div className="cs_main_header_in">
            ...
            <div className="header2-buttons">
                    <div className="button">
                      <Link className="theme-btn2" to="/contact">Get A Quote <span className="arrow1"><i className="bi bi-arrow-right"></i></span><span className="arrow2"><i className="bi bi-arrow-right"></i></span></Link>
                    </div>
               </div>
            </div>
          </div>
