    ...
    return (
        <div>
            <HeroBanner5
                ...
                btntwourl="/service"
                image1="/assets/img/hero/hero7-image.webp"
                shape2="/assets/img/shapes/hero7-shape1.webp"
                shape3="/assets/img/shapes/hero7-shape2.webp"
                shape4="/assets/img/shapes/hero7-shape3.webp"
                shape5="/assets/img/shapes/hero7-shape7.webp"
            ></HeroBanner5>
            <About5
                image1="/assets/img/about/about7-image.webp"
                experienceNum="20+"
